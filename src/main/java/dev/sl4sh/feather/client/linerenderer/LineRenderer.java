package dev.sl4sh.feather.client.linerenderer;
...
public final class LineRenderer implements DebugRenderer.Renderer {
    ...
    public static void drawLine(Line line, long ms){

        INSTANCE.renderedLines.add(line);
        if (ms <= 0){
            ms = 10000;
        }
        ...
        new Timer().schedule(task(() -> {
            ...
            INSTANCE.pendingRemove.add(line);
